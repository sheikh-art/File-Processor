...
// Variables can be defined inline as well.
const ref = createUserRef({ fullName: ..., email: ..., role: ..., });
...
// Variables can be defined inline as well.
const { data } = await createGroup({ name: ..., type: ..., adminUserId: ..., });
...
// Variables can be defined inline as well.
const ref = createGroupRef({ name: ..., type: ..., adminUserId: ..., });
...
// Variables can be defined inline as well.
const ref = joinGroupRef({ userId: ..., groupId: ..., });
